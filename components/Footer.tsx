        ...
        <div className="grid grid-cols-1 gap-10 md:grid-cols-3 lg:grid-cols-4">
          <div className="lg:col-span-1">
            ...
            <div className="mt-5 flex gap-3">
              <a
                href={UNIT.contact.instagramUrl}
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Instagram"
                className="rounded-full bg-white/10 p-2.5 transition hover:bg-xv-orange"
              >
                <InstagramIcon size={18} />
              </a>
              <a
                href={UNIT.contact.facebookUrl}
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Facebook"
                className="rounded-full bg-white/10 p-2.5 transition hover:bg-xv-orange"
            ...
            <ul className="mt-4 space-y-2.5 text-sm">
              {[
                ...
                <li key={href}>
                  <Link
                    href={href}
                    className="text-white/80 transition hover:text-xv-orange"
                  >
                    {label}
                  </Link>
                </li>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-3 text-sm">
              <li className="flex items-start gap-2 text-white/80">
                <MapPin size={16} className="mt-0.5 flex-shrink-0 text-xv-cyan" />
                <span>
                  {UNIT.address.street}
                  <br />
              ...
              <li className="flex items-start gap-2 text-white/80">
                <Clock size={16} className="mt-0.5 flex-shrink-0 text-xv-cyan" />
                <span>{UNIT.hours.summary}</span>
              </li>
              <li className="flex items-start gap-2 text-white/80">
                <MessageCircle size={16} className="mt-0.5 flex-shrink-0 text-xv-cyan" />
                <a
                  href={whatsappUrl("home")}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="hover:text-xv-orange"
                >
                  {UNIT.contact.whatsappDisplay}
                </a>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="mt-5 inline-flex items-center gap-2 rounded-full bg-[#25D366] px-5 py-2.5 text-sm font-bold text-white shadow-md hover:brightness-110"
            >
