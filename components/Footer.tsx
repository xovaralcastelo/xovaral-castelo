    ...
    <footer className="bg-primary text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-14">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div className="md:col-span-2">
            ...
            <div className="flex gap-3">
              <a
                ...
                className="w-10 h-10 bg-white/10 rounded-xl flex items-center justify-center hover:bg-orange transition-colors"
          ...
          {/* Nav */}
          <div>
            <h4 className="font-bold text-sm uppercase tracking-wide text-white/40 mb-4">
              Navegação
            </h4>
