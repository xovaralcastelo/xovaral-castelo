...
const NAV: {
  ...
  { href: "/admin/categories", label: "Categorias", icon: Tags, section: "categories" },
  { href: "/admin/orders", label: "Pedidos", icon: ShoppingBag, section: "orders" },
  { href: "/admin/store", label: "Config. da Store", icon: Store, section: "store" },
